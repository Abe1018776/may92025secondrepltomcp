...
TRANSLATIONS = {
    "he": {
        ...
        # Settings - Always keep in English 
        ...
        # RAG settings - Always keep in English
        "retrieval_count": "Paragraphs to retrieve",
        "validation_count": "Paragraphs to validate (GPT-4o)",
        ...
        "example_questions": "Example Questions",  # Keep in English for sidebar
        "prompt_templates": "Prompt Templates",    # Keep in English for sidebar
...
The code was modified to ensure the sidebar titles (Settings, Display Settings, Language, Hebrew Font, Retriever (Pinecone), OpenAI, Paragraphs to retrieve, Paragraphs to validate, Validation Info, Edit Prompts, System Prompt, Validation Prompt, Example Questions, Prompt Templates) are always displayed in English, even when the selected language is Hebrew. This was achieved by modifying the `TRANSLATIONS` dictionary for the Hebrew language ("he") to keep these specific keys in English.
